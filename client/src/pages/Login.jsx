// Login.jsx (updated with API integration and toast)
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      toast.update(loadingToast, {
        render: result.error || "Login failed. Please try again.",
        type: "error",
        isLoading: false,
        autoClose: 3000,
      });
              ...
              <div className="relative hidden md:block">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                  ...
                  <p className="text-gray-200 mb-4">
                    Sign in to continue your journey finding the perfect
                    boarding space.
                  </p>
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <div className="w-1.5 h-1.5 bg-primary rounded-full"></div>
                      <span className="text-sm">Connect with landlords</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 md:p-10">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    Sign in to your BH4RENT account
                  </p>
                </div>
